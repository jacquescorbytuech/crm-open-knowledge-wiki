...
* [Browser push](browser-push.md) - web push to a granted browser; the way back for a web product with no app; the one notification channel that reaches the desktop.
