...
* [Legislation and compliance](legislation-and-compliance.md) - CAN-SPAM, GDPR, UK GDPR, PECR, CASL and CCPA, with a practical minimum.
* [Tracking and measurement consent](tracking-and-measurement-consent.md) - why open and click tracking is a separate consent question from the right to send, plus the 2026 French and Italian rulings on email tracking pixels.
* [Glossary](glossary.md) - the working vocabulary of lifecycle and CRM marketing.
