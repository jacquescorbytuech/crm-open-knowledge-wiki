...
When in doubt, over-disclose. A one-line note in the PR, such as "I work for X; this citation is to their docs because it's the primary source for Y", is exactly right, and an authoritative first-party source cited honestly is welcome.
